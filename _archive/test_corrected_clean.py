"""
Test Facebook Post Script (Clean version)
"""
...
def test_facebook_post():
    ...
    try:
        ...
        if page_response.status_code == 200:
            ...
            print(f"SUCCESS: Connected to page: {page_data.get('name', 'Unknown Page')}")
        else:
            print(f"FAILED: Could not connect to page: {page_response.status_code}")
